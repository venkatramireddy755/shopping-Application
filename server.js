...
// app.use(bodyParser.json());
// app.use(cors({
//     origin: 'http://localhost:3000',  // Adjust this based on the front-end URL
//   }));
...
//     const { total } = req.body; // total passed from client
//     try {
...
//             ],
//             mode: 'payment',
//             success_url: 'http://localhost:8000/success', // Replace with your success page route
//             cancel_url: 'http://localhost:8000/cancel', // Replace with your cancel page route
//         });
